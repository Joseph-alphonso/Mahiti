        ...
        return this.each(function () {
            ...
            function meanCentered() {
            	if (meanRevealPosition == "center") {
	            	...
	            	var meanCenter = ( (newWidth/2)-0 )+"px";
            ...
            function showMeanMenu() {
                if (currentWidth <= meanScreenWidth) {
                	...
                	jQuery('.mean-container').prepend('<div class="mean-bar"><span class="menu-head">Menu</span><a href="#nav" class="meanmenu-reveal" style="'+meanStyles+'">Show Navigation</a><nav class="mean-nav"></nav></div>');
