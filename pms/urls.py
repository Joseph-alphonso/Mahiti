...
urlpatterns = patterns('',
    ...
    url(r'^clients/$','client.views.client_list',name='client_list'),
    ...
    url('^project/dashboard/(?P<id_disp>\d+)/$','projects.views.project_dashboard',name='project_dashboard'),
    ...
    url(r'^task/add-document/(?P<tid>\d+)/$', 'documents.views.add_document', name='add-document'),
    url(r'^task/edit-document/(?P<tid>\d+)/$', 'documents.views.edit_document', name='edit-document'),
    url(r'^task/delete-document/(?P<tid>\d+)/$', 'documents.views.delete_document', name='delete-document'),
    url(r'^task/activate-document/(?P<tid>\d+)/$', 'documents.views.activate_document', name='activate-document'),
    ...
    url(r'^task/assigned/$','tasks.views.task_assigned',name='assign'),
    url(r'^task/ownedby/$','tasks.views.task_ownedby', name='task'),
    url(r'^task/following/$','tasks.views.task_following', name='task_following'),
    url(r'^gettasks/$','tasks.views.gettasks',name='gettasks'),
    url(r'^getmilestones/$','tasks.views.getmilestones',name='getmilestones'),
    url(r'^getmodules/$','tasks.views.getmodules',name='getmodules'),
    url(r'^getclients/$','projects.views.getclients',name='getclients'),
    url(r'^search/$', 'tasks.views.search', name='search'),
    url(r'^task/requests/$','tasks.views.task_requests', name='task_requests'),
    url(r'^task/request/add/$', 'tasks.views.task_request_add', name='task_request_add'),
    url(r'^task/request/view/(?P<id_disp>\d+)/$','tasks.views.task_request_view',name='task_request_view'),
    url(r'^task/edit/(?P<id_edit>\d+)/$','tasks.views.task_edit', name='edit'),
    url(r'^task/request/edit/(?P<id_edit>\d+)/$','tasks.views.task_request_edit', name='task_request_edit'),
    url(r'^task/assign/(?P<id_disp>[0-9]+)/$','tasks.views.add_task_request_to_new_task',name='add_task_request_to_new_task'),
    url(r'^task-commend/$', 'tasks.views.task_commend', name = "task-commend"),
    #    url(r'^deletetasks/(?P<id_delete>\d+)/$','documents.views.deletetasks', name='deletetasks'),
    url(r'^tasks/view/$', 'tasks.views.task_with_no_assignees', name= 'task_with_no_assignees' ),



    # url for milestones
    url(r'^milestone/view/(?P<id_disp>\d+)/$','milestones.views.view',name='view'),
    ...
    url(r'^milestones/(?P<task>(:?add|:?edit))/(?P<id>[0-9]+)/$', 'milestones.views.addmilestone', name='addmilestone'),
    url(r'^milestones/owned by me/$','milestones.views.milestone_owned_by', name='milestone_owned_by'),
    ...
    url(r'^milestones/overdue/$','milestones.views.overdueview', name='overdueview'),
    url(r'^milestones/search/$', 'milestones.views.search', name='search'),
    url(r'^mile-comment/','milestones.views.milestone_comment', name="mile_comment"),
...
#---------------------------Times----------------------------------------#
    ...
    url(r'^times/manage/timesheets/(?P<task>(:?submit|:?approve|:?reject))/$','times.views.manage_time_sheets', name='manage_time_sheets'),
    url(r'^times/manage/timesheets/','times.views.manage_timesheets',name='manage_timesheets'),
...
#----------------mastermodule---------------------------
    ...
    url(r'^settings/resource/categorization/(?P<task>(:?add|:?edit|:?delete|:?active))/(?P<id>[0-9]+)/$','mastermodule.views.resource_categorizations_details',name='resource_categorizations_details'),
    url(r'^settings/resource/categorizations/$','mastermodule.views.resource_categorization_list',name='resource_categorization_list'),
    url(r'^settings/project/categorization/(?P<task>(:?add|:?edit|:?delete|:?active))/(?P<id>[0-9]+)/$','mastermodule.views.project_categorization_details',name='project_categorizations_details'),
    url(r'^settings/project/categorizations/$','mastermodule.views.project_categorization_list',name='project_categorization_list'),
    url(r'^settings/task/priorities/(?P<task>(:?add|:?edit|:?delete|:?active))/(?P<id>[0-9]+)/$','mastermodule.views.task_priorities_details',name='task_priorities_details'),
    url(r'^settings/task/priorities/$','mastermodule.views.task_priorities_list',name='task_priorities_list'),
    url(r'^settings/statuses/$','mastermodule.views.task_staus_details',name = 'task_staus_details'),
    url(r'^settings/statuses/(?P<task>(:?add|:?edit|:?delete|:?active))/(?P<id>[0-9]+)/$','mastermodule.views.task_statuses',name='task_statuses'),
